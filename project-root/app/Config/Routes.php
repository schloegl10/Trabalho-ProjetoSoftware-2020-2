...
$routes->match(['get','post'], '/Empresa/AlteraDados', 'Empresa::alteraDados', ['filter' => 'autenticador']);
$routes->match(['get','post'], '/Empresa/alteraOportunidade', 'Empresa::alteraOportunidade', ['filter' => 'autenticador']);
$routes->match(['get','post'], '/Empresa/cadastraOportunidade', 'Empresa::criaOportunidade', ['filter' => 'autenticador']);
